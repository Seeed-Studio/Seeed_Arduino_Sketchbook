...
void setup(void) {
    ...
    ads.setSampleRate(ADS1115_DR_128);
//    tft.setCursor(10, 200);
    tft.setTextColor(TFT_WHITE);
    tft.setFreeFont(FSS12);
    tft.drawString("- Voltage Level: ", 10, 175);
//    tft.drawString("- Battery Vol: ", 10, 210);

    spr.createSprite(100, 150);
...
void loop() {
    ...
    adc01 = ads.getConversionResults(channel23);
...
//        value[0] = 50 + 50 * sin((d + 0) * 0.0174532925);
    ...
    spr.drawFloat(adc0*0.1875*0.001,4, 0, 0);
//    spr.drawFloat(adc01*0.1875*0.001, 2, 0, 35);
    
    spr.pushSprite(185,175);
}
